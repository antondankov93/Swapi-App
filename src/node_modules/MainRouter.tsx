...
import {PlanetsComparison} from "components/charts/planets-comparison/PlanetsComparison";
...
import {PlanetsComparisonChart} from "components/charts/planets-comparison/PlanetsComparisonChart";
import {ShipsComparisonChart} from "components/charts/starships-comparison/ShipsComparisonChart";
            ...
            {transition.map(({item, props, key}) => (
                <animated.div key={key} style={props} >
                    <Switch location={item}>
                        ...
                        <Route path='/charts/population' render={() => <PlanetsComparison/>}/>
                        <Route path='/charts/planets-comparison' render={() => <PlanetsComparisonChart/>}/>
                        <Route path='/charts/starships' render={() => <StarshipsComparison/>}/>
                        <Route path='/charts/starships-comparison' render={() => <ShipsComparisonChart/>}/>
                        ...
                        <Route path='/world/characters' render={() => <Characters/>}/>
                        <Route path='/world/films' render={() => <Films/>}/>
                        <Route path='/world/planets' render={() => <Planets/>}/>
