...
export const Characters = () => {
    const {allCharacters, isLoading} = useCharactersFetch()
                        ...
                        <Carousel.Item>
                            <div className={s.mainContent}>
                                ...
                                <aside className={cn(s.characterInfo, s.right)}>
                                    <p><span>home planet:</span> <NavLink to='/'>Planet
                                        № {cr.homeworld.slice(-2, -1)}</NavLink></p>
                                    <div className={s.films}>
                                        <h4>Was in the:</h4>
                                        {cr.films.map((f: string | any[]) => <NavLink to='/'>Movie № {f.slice(-2, -1)}</NavLink>)}
                                    </div>
                                </aside>
                            </div>
                            <Carousel.Caption>
